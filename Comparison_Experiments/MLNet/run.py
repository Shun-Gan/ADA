...
class Trainer():
    ...
    def __init__(self, dataset, epochs=10, lr=0.01, momentum=0.8, bz=20, 
                ...
                best_weight='', copy_code_flag=True):
        ...
        self.prior_size = (int(self.img_size[0]/16), int(self.img_size[1]/16)) #
        self.freeze_layer=23
        self.net = MLNet(self.prior_size).cuda()
        ...
        self.criteon = ModMSELoss(self.img_size[0]/8, self.img_size[1]/8).cuda()  
    ...
    def fit(self, train_loader, val_loader, clip_=False):
        ...
        for epoch in range(self.epochs):
            ...
            for batch_idx, (input, target) in enumerate(train_loader):
                ...
                loss = self.criteon(output, target, self.net.prior.clone())
    ...
    def evaluate(self, phase, db_loader, epoch=None):
        ...
        with torch.no_grad():
            ...
            for batch_idx, data_batch in enumerate(db_loader):
                ...
                losses += self.criteon(logits, map_bh, self.net.prior.clone()).item()
...
class ModMSELoss(torch.nn.Module):
    def __init__(self,shape_r_gt,shape_c_gt):
        ...
        self.shape_r_gt = int(shape_r_gt)
        self.shape_c_gt = int(shape_c_gt)
...
if __name__=="__main__":
        ...
        for dataset in ["DADA2000"]:
            ...
            Trainer_ = Trainer(dataset=dataset,
                                ...
                                weight_decay=5e-4,
                                bz=bz, 
                                best_weight='./runs/DADA2000_2021-12-08_011240/best_weight_DADA2000.pt'
                                )
        ...
        #     Trainer_ = Trainer(dataset=dataset,
        #                         best_weight='./runs/DReye_2021-11-23_013026/best_weight_DReye.pt',
        #                         bz=bz, 
