...
class Trainer():
    ...
    def __init__(self, dataset, epochs=10, lr=0.01, momentum=0.8, bz=20, 
        ...
        for param in self.net.Vgg16_fine_features.parameters():
            param.requires_grad = False
        for param in self.net.Vgg16_coarse_features.parameters():
            param.requires_grad = False 
    ...
    def fit(self, train_loader, val_loader, clip_=False):
        ...
        for epoch in range(self.epochs):
            ...
            for batch_idx, (inputs, target) in enumerate(train_loader):
                ...
                fine_img, coarse_img = fine_img.cuda(), coarse_img.cuda()
                target = target.cuda()
                output = self.net(fine_img, coarse_img)
    ...
    def evaluate(self, phase, db_loader, epoch=None):
        ...
        with torch.no_grad():
            ...
            for batch_idx, (inputs, target, fix_bh) in enumerate(db_loader):
                ...
                target = target.cuda()
                t0=time.time()
                logits = self.net(fine_img, coarse_img)
...
if __name__=="__main__":
        ...
        for dataset in ["DADA2000"]:
            ...
            Trainer_ = Trainer(dataset=dataset,
                                ...
                                weight_decay=5e-4,
                                bz=bz, 
                                best_weight='./runs/DADA2000_2021-12-08_162738/best_weight_DADA2000.pt'
                                )
