...
from model import ACLNet, ACLLoss
import utils
...
class Trainer():
    ...
    def __init__(self, dataset, epochs=10, lr=0.01, momentum=0.8, bz=20, 
        ...
        self.cnn_lr_gamma=0.02 # scaled lr for pre-trained vgg 
        ...
        self.net = ACLNet().cuda()
        self.cnn_params=[]
        self.new_params=[]
        for name, params in self.net.named_parameters():
            if 'Vgg_feats' in name:
    ...
    def fit(self, train_loader, val_loader, clip_=False):
        ...
        for epoch in range(self.epochs):
            ...
            for cnn_param in self.net.Vgg_feats.parameters():
            ...
            timestamp = time.time()
            print('########## epoch {:0>3d}; \t new_params lr: {:.8f} ##########'.format(epoch, 
                    self.optimizer.param_groups[0]["lr"]))
            if cnn_grad: print('vgg lr:  {:.8f}'.format(self.optimizer.param_groups[1]["lr"]))
...
if __name__=="__main__":
        ...
        data_config = {"EyeTrack":[1000, 0.99, 35, 40],
                     "DReye":[200, 0.95, 18, 20], 
                     "DADA2000":[200, 0.95, 18, 20],
                      "BDDA":[200, 0.95, 18, 20]}
        num_workers= 0
        bz = 8
        torch_seed(2021)
        ...
        for dataset in ["DADA2000"]:
            ...
            Trainer_ = Trainer(dataset=dataset,
                                ...
                                best_weight='./runs/DADA2000_2021-11-23_183955/best_weight_DADA2000.pt'
                                )
        ...
        #     Trainer_ = Trainer(dataset=dataset,
        #                         best_weight='./runs/DReye_2021-11-23_181701/best_weight_DReye.pt',
        #                         bz=bz, 
