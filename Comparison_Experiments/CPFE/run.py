...
from inferece import Example_prediction
...
class Trainer():
    ...
    def __init__(self, dataset, epochs=10, lr=0.01, momentum=0.8, bz=20, 
        ...
        self.criteon = EdgeSaliencyLoss('cuda')     
    ...
    def fit(self, train_loader, val_loader, clip_=False):
        ...
        for epoch in range(self.epochs):
            ...
            for batch_idx, (inputs, target) in enumerate(train_loader):
                fine_img = inputs.cuda()
                target = target.cuda()
                output, ca_act_reg = self.net(fine_img)

                loss = self.criteon(output, target)+ca_act_reg
                if torch.isnan(loss):
                    continue
                ...
                if batch_idx % 200 == 0:
                    ...
                    print('\n Train Epoch: {}/{} [{}/{} ({:.0f}%)]\tLoss: {:.6f}'.format(
                        epoch, self.epochs, batch_idx * len(fine_img), len(train_loader.dataset),
    ...
    def evaluate(self, phase, db_loader, epoch=None):
        ...
        if phase == 'valid':
            ...
            # predictor.infer_example(self.net, self.outpath)
...
if __name__=="__main__":
        ...
        for dataset in ["DADA2000"]:
            ...
            Trainer_ = Trainer(dataset=dataset,
                                ...
                                weight_decay=5e-4,
                                bz=bz, 
                                best_weight='./runs/DADA2000_2021-12-07_150411/best_weight_DADA2000.pt'
                                )
        ...
        # for dataset in dataset_list:
        #     Trainer_ = Trainer(dataset=dataset,
        #                         best_weight='./runs/DReye_2021-11-24_031814/best_weight_DReye.pt',
        #                         bz=bz, 
