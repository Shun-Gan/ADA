...
class Data_load():
    def __init__(self):
        ...
        self.data_dict={"EyeTrack":[[97, 119, 154],[256, 256],'EyeTrack'],
                        "DReye":[[379, 406, 780],[256, 256],'New_DReye'],
                        # "DADA2000":[[698, 798, 1014],[256, 256],'DADA'], # 避免报错统一
                        "DADA2000":[[0, 1, 220],[256, 256],'DADA_test'],
                        "BDDA":[[927, 1127, 1429],[256, 256],'BDDA']}
    ...
    def load_list(self, dataset, phase, clip_=True):
        ...
        if clip_:
            clip_dict={"EyeTrack":2, "DReye":6, "DADA2000":8, "BDDA":10}
...
class Data_Dataset(Dataset):
    ...
    def load_input_data(self, data_file):
        ...
        fine_data = cv2.resize(fine_data, tuple((int(self.img_size[1]), int(self.img_size[0]))), 
